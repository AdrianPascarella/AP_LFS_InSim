...
def is_target_ahead_and_in_lane(
    my_coords: Any,
    target_point: Any,
    other_car_coords: Any,
    max_lateral_dist: float = 2.5,
    min_ahead_dist: float = 0.0,
    max_ahead_dist: float = 120.0,
    ...
    dist_to_car = calc_dist_3d(
        ...
        my_coords.y_m,
        my_coords.z_m,
        other_car_coords.x_m,
        other_car_coords.y_m,
        other_car_coords.z_m,
    )
