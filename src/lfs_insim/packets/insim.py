...
class ISP_NPL(PacketFunctions):
    ...
    Tyres: tuple[TYRE, TYRE, TYRE, TYRE] = field(
        default=(0, 0, 0, 0), metadata={"fmt": repeat("B", 4)}
    )
...
class ISP_REO(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    NumP: int = field(default=0, metadata={"fmt": "B"})
    PLID: tuple[int, ...] = field(
        default_factory=lambda: tuple(0 for _ in range(48)),
        metadata={"fmt": repeat("B", 48)},
    )
...
class ISP_NLP(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    NumP: int = field(default=0, metadata={"fmt": "B"})
    Info: list[NodeLap] = field(
        default_factory=lambda: [], metadata={"fmt": (NodeLap, None)}
    )
...
class ISP_MCI(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    NumC: int = field(default=0, metadata={"fmt": "B"})
    Info: list[CompCar] = field(
        default_factory=lambda: [], metadata={"fmt": (CompCar, None)}
    )
...
class ISP_AXM(PacketFunctions):
    ...
    Sp3: int = field(default=0, metadata={"fmt": "B"})
    Info: list[ObjectInfo] = field(
        default_factory=lambda: [], metadata={"fmt": (ObjectInfo, None)}
    )
...
class ISP_HCP(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    Zero: int = field(default=0, metadata={"fmt": "B"})
    Info: list[CarHCP] = field(
        default_factory=lambda: list(CarHCP() for _ in range(32)),
        metadata={"fmt": repeat(CarHCP, 32)},
    )
...
class ISP_JRR(PacketFunctions):
    ...
    Sp2: int = field(default=0, metadata={"fmt": "B"})
    Sp3: int = field(default=0, metadata={"fmt": "B"})
    StartPos: ObjectInfo = field(
        default_factory=ObjectInfo, metadata={"fmt": ObjectInfo}
    )
...
class ISP_PLH(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    NumP: int = field(default=0, metadata={"fmt": "B"})
    HCaps: list[PlayerHCap] = field(
        default_factory=lambda: [], metadata={"fmt": (PlayerHCap, None)}
    )
...
class ISP_IPB(PacketFunctions):
    ...
    Sp2: int = field(default=0, metadata={"fmt": "B"})
    Sp3: int = field(default=0, metadata={"fmt": "B"})
    BanIPs: list[tuple[int, int, int, int]] = field(
        default_factory=lambda: [], metadata={"fmt": ("4B", None)}
    )
...
class ISP_AIC(PacketFunctions):
    ...
    ReqI: int = field(default=0, metadata={"fmt": "B"})
    PLID: int = field(default=0, metadata={"fmt": "B"})
    Inputs: list[AIInputVal] = field(
        default_factory=lambda: [], metadata={"fmt": (AIInputVal, 20)}
    )
...
class ISP_SET(PacketFunctions):
    ...
    Sp2: int = field(default=0, metadata={"fmt": "B"})
    Sp3: int = field(default=0, metadata={"fmt": "B"})
    Setup: list[int] = field(
        default_factory=lambda: [0] * 120, metadata={"fmt": ("B", 120)}
    )
